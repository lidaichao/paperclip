    ...
    <aside className="w-full h-full min-h-0 border-r border-border bg-background flex flex-col">
      ...
      <nav className="flex-1 min-h-0 overflow-y-auto scrollbar-auto-hide flex flex-col gap-4 pointer-coarse:gap-3 px-3 py-2">
        ...
        <SidebarSection label={l10n("local.work_104ab921")} collapsible={{ open: workOpen, onOpenChange: setWorkOpen }}>
          <SidebarNavItem to="/issues" label={l10n("local.tasks_b3a60e61")} icon={CircleDot} />
          {showCases ? (
        ...
        <SidebarSection label={l10n("local.company_de4743c8")} collapsible={{ open: companyOpen, onOpenChange: setCompanyOpen }}>
          <SidebarNavItem to="/org" label={l10n("local.org_b1ee7e97")} icon={Network} />
          {showApps ? <SidebarNavItem to="/apps" label={l10n("local.connectors_c3d2e79e")} icon={Unplug} /> : null}
