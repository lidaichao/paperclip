...
export function DocumentAnnotationPopover(props: DocumentAnnotationPopoverProps) {
  ...
  return (
    <div
      ref={cardRef}
      role="dialog"
      aria-label={props.pendingAnchor ? l10n("local.add_annotation_comment_bbe4df5f") : l10n("local.annotation_thread_ee8c607d")}
      ...
      {props.pendingAnchor ? (
        <div className="p-3">
          ...
          <div className="mt-2 flex justify-end gap-2">
            <Button type="button" size="sm" variant="ghost" onClick={props.onClose}>{l10n("local.cancel_19766ed6")}</Button>
