...
const levelLabels: Record<string, string> = {
  ...
  team: l10n("local.team_5985039f"),
  agent: l10n("local.agent_11b39c93"),
  task: l10n("local.task_4bc74b21"),
};
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-b border-border">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span>{newGoalDefaults.parentId ? l10n("local.new_sub_goal_691ebb16") : l10n("local.new_goal_f326ad6e")}</span>
          </div>
        ...
        <div className="px-4 pt-4 pb-2 shrink-0">
          <input
            ...
            placeholder={l10n("local.goal_title_adb0cfb0")}
            value={title}
          ...
          <Popover open={parentOpen} onOpenChange={setParentOpen}>
            <PopoverTrigger asChild>
              <button className="inline-flex items-center gap-1.5 rounded-md border border-border px-2 py-1 text-xs hover:bg-accent/50 transition-colors">
                ...
                {currentParent ? currentParent.title : l10n("local.parent_goal_9ff9195c")}
              </button>
            </PopoverTrigger>
        ...
        <div className="flex items-center justify-end px-4 py-2.5 border-t border-border">
          ...
          >
            {createGoal.isPending ? l10n("local.creating_c79ed949") : newGoalDefaults.parentId ? l10n("local.create_sub_goal_f6444df9") : l10n("local.create_goal_9f58bb98")}
          </Button>
        </div>
      </DialogContent>
    </Dialog>
