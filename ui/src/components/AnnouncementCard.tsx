...
export function AnnouncementCard({ announcement, onDismiss, imageSrc, animationSrc, className }: AnnouncementCardProps) {
  ...
  return (
    ...
    >
      ...
      <Button variant="secondary" size="icon" aria-label={l10n("local.dismiss_announcement_a206fa8e")} onClick={onDismiss} className="absolute right-2 top-2 z-10 size-8 rounded-full shadow-sm">
