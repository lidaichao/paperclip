      ...
      <div className="flex min-w-0 items-start gap-3">
        ...
        <div className="min-w-0">
          <div className="flex items-center gap-2">
            ...
            <p className="truncate text-sm font-semibold text-foreground">{l10n("local.integration_smoke_287f3802")}</p>
          </div>
          ...
          <p className="mt-0.5 truncate text-(length:--text-micro) text-muted-foreground/80">
            {latestRun ? l10n("local.last_run_value_fd5d7e6e", {v0: (formatTime(latestRun.startedAt))}) : l10n("local.run_one_from_the_smoke_lab_tab_0de15b47")}
          </p>
        </div>
      </div>
