    ...
    >
      ...
      {taskDetailLayout ? (
        <Button
          ...
          aria-label={taskPanelOpen ? l10n("local.hide_properties_dd66dbf9") : l10n("local.show_properties_ae4293fc")}
          title={taskPanelOpen ? l10n("local.hide_properties_dd66dbf9") : l10n("local.show_properties_ae4293fc")}
        >
