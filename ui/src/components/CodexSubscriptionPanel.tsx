    ...
    <div className="border border-border px-4 py-4">
      <div className="flex items-start justify-between gap-3 border-b border-border pb-3">
        <div className="min-w-0">
          <div className="text-(length:--text-micro) font-semibold uppercase tracking-(--tracking-caps) text-muted-foreground">
            {l10n("local.codex_subscription_3e08a5f5")}</div>
          <div className="mt-1 text-sm text-muted-foreground">
            {l10n("local.live_codex_quota_windows_eff0db96")}</div>
        </div>
        {source ? (
      ...
      <div className="mt-4 space-y-5">
        <div className="space-y-3">
          <div className="text-(length:--text-micro) font-semibold uppercase tracking-(--tracking-caps) text-muted-foreground">
            {l10n("local.account_windows_17b84055")}</div>
          <div className="space-y-3">
        ...
        {modelWindows.length > 0 ? (
          <div className="space-y-3">
            <div className="text-(length:--text-micro) font-semibold uppercase tracking-(--tracking-caps) text-muted-foreground">
              {l10n("local.model_windows_e830a424")}</div>
            <div className="space-y-3">
    ...
    <div className="border border-border px-3.5 py-3">
      <div className="flex items-start justify-between gap-3">
        ...
        <div className="shrink-0 text-sm font-semibold tabular-nums text-foreground">
          {window.usedPercent}{l10n("local._used_19e8fbbc")}</div>
      </div>
