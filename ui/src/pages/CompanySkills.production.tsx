...
const SOURCE_FILTER_LABELS: Record<SourceFilter, string> = {
  ...
  company: l10n("local.company_de4743c8"),
    ...
    >
      <div className="flex items-start gap-3">
        ...
        {(() => {
          ...
          return (
            <span className="shrink-0 text-muted-foreground" title={l10n("local.from_value_b49051d9", {v0: (meta.label)})} aria-label={l10n("local.from_value_b49051d9", {v0: (meta.label)})}>
      ...
      <div className="mt-auto pt-3">
        ...
        <div className="flex items-center gap-2 text-(length:--text-micro) text-muted-foreground">
          <span>{card.agentCount} {card.agentCount === 1 ? l10n("local.agent_d4f0bc5a") : l10n("local.agents_8c70b25c")}</span>
          {card.starCount > 0 ? (
            <>
    ...
    <div className="flex min-h-(--sz-calc-30) md:h-(--sz-calc-33) md:min-h-0 md:overflow-hidden">
      ...
      <aside className={cn("hidden w-60 shrink-0 flex-col overflow-hidden border-r border-border md:flex", showFolderRail && "md:hidden")}>
        <div className="border-b border-border px-4 py-4">
          <h2 className="text-sm font-semibold text-foreground">{l10n("local.skills_store_4fd92676")}</h2>
          <p className="text-xs text-muted-foreground">{l10n("local.discover_install_fork_share_193278f9")}</p>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2 border-b border-border px-4 py-3">
          <div className="flex h-9 min-w-(--sz-12rem) flex-1 items-center gap-2 rounded-md border border-border px-2.5">
            ...
            <input
              ...
              placeholder={l10n("local.search_skills_authors_categories_cfc3b145")}
              ...
              <DropdownMenuTrigger asChild>
                <Button variant="outline" size="sm">
                  ...
                  <span className="ml-1.5 capitalize">
                    {sourceBadgeFilter === "all" ? l10n("local.all_a52ace42") : sourceMeta(sourceBadgeFilter as CompanySkillSourceBadge, null).label}
                  </span>
                  <ChevronDown className="ml-1 h-3.5 w-3.5" />
                </Button>
              </DropdownMenuTrigger>
          ...
          <Button asChild variant="outline" size="sm">
            <Link to="/skills/studio">
              ...
              {l10n("local.studio_0aa91af2")}</Link>
          </Button>
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem onSelect={onBrowseCatalog}>
                ...
                {l10n("local.browse_catalog_4d05dc6d")}</DropdownMenuItem>
          ...
          <Tabs value={tab} onValueChange={(value) => onTabChange(value as DiscoveryTab)}>
            <TabsList variant="line" className="p-0">
              ...
              <TabsTrigger value="installed" className="px-3">
                <span>{l10n("local.installed_f8b32f4e")}</span>
              ...
              <TabsTrigger value="catalog" className="px-3">
                <span>{l10n("local.catalog_3877d148")}</span>
              ...
              <TabsTrigger value="bundled" className="px-3">
                <span>{l10n("local.bundled_79d3a1f1")}</span>
              ...
              {totalCount === 0 ? (
                <div className="mt-3 flex flex-col items-center gap-2">
                  <Button size="sm" onClick={onBrowseCatalog}>
                    <Boxes className="mr-1.5 h-3.5 w-3.5" /> {l10n("local.browse_catalog_4d05dc6d")}</Button>
      ...
      {step === 0 ? (
        ...
        <div className="space-y-4 text-sm">
          <div className="grid grid-cols-(--gtc-26) gap-y-2">
            ...
            <span>{draft.sharingScope === "private" ? l10n("local.private_c63eb672") : l10n("local.company_de4743c8")}</span>
          ...
          <div className="space-y-2">
            ...
            <div className="grid gap-2 sm:grid-cols-3">
              {(["company", "private"] as const).map((scope) => (
                ...
                >
                  <span className="block font-medium">{scope === "company" ? l10n("local.company_de4743c8") : l10n("local.private_c63eb672")}</span>
                  <span className="mt-1 block text-xs text-muted-foreground">
                    {scope === "company" ? l10n("local.visible_inside_this_company_ab5f5c60") : l10n("local.only_visible_in_your_library_efbca227")}
                  </span>
                </button>
              ))}
              <button
          ...
          {defaultAction === "install" ? (
            <div className="rounded-md border border-border p-3">
              ...
              <p className="mb-2 text-xs text-muted-foreground">
                {l10n("local.installing_adds_the_skill_to_the_company_libr_ccbb66cc")}</p>
              <AgentMultiSelect
                agents={agents}
                ...
                emptyMessage={l10n("local.no_agents_in_this_company_support_skills_yet_3a819471")}
...
function AttachAgentsPopover({
  ...
  return (
    <AgentMultiSelect
      ...
      emptyMessage={eligible.length === 0 ? l10n("local.no_agents_in_this_company_support_skills_yet_3a819471") : l10n("local.no_agents_yet_8a33b2e7")}
      isAgentDisabled={(agent) => {
        const option = agent as AttachAgentOption;
        return option.required || !option.supportsSkills;
      }}
          ...
          <div className="flex flex-wrap items-center justify-end gap-1">
            ...
            <div className="flex items-center overflow-hidden rounded-md border border-border">
              <Tooltip>
                ...
                <TooltipContent>{l10n("local.agents_in_this_company_that_currently_have_th_295abab7")}</TooltipContent>
              </Tooltip>
              <button
                type="button"
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              >
                <option value="company">{l10n("local.company_visible_inside_this_company_c0ff67de")}</option>
            ...
            {detail.editable ? (
              <div className="rounded-md border border-destructive/40 p-3">
                ...
                <div className="mt-2 flex items-center justify-between gap-3">
                  <p className="min-w-0 text-xs text-muted-foreground">{l10n("local.remove_this_skill_from_the_company_library_30ea4035")}</p>
                  <Button
                    variant="destructive"
                    size="sm"
                    className="shrink-0"
...
export function CompanySkills() {
  ...
  const deleteSkill = useMutation({
    ...
    onSuccess: async (skill) => {
      ...
      pushToast({
        ...
        body: l10n("local.value_was_removed_from_the_company_skill_libr_90bf26b8", {v0: (skill.name)}),
      });
    },
    onError: (error) => {
  ...
  const studioDescription = studioForkFromId
    ? l10n("local.review_the_fork_metadata_and_create_an_editab_e08968ef")
    : l10n("local.create_an_editable_company_skill_in_the_paper_adcb4319");
  return (
    <>
      {policyDenial.denial ? (
      ...
      <Dialog open={deleteOpen} onOpenChange={closeDeleteDialog}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              {l10n("local.remove_this_skill_from_the_company_library_if_852f3e89")}</DialogDescription>
          </DialogHeader>
      ...
      <Dialog open={importDialogOpen} onOpenChange={setImportDialogOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              {l10n("local.paste_a_local_path_github_url_or_skills_sh_co_193e6a76")}</DialogDescription>
          </DialogHeader>
          <div className="space-y-3">
