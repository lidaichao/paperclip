  ...
  return (
    <div className="space-y-6">
      <InboxCollectionToolbar
        ...
        ariaLabel={l10n("local.inbox_controls_db4eae19")}
        context={(
          <Tabs value={tab} onValueChange={(value) => navigate(`/inbox/${value}`)}>
            <PageTabBar
              items={[
                { value: "mine", label: l10n("local.mine_f57afb7d") },
                    ...
                    <IssueRow
                      ...
                      leadingControl={streamlinedUiEnabled && nestingEnabled && hasChildren && collapseParentId ? (
                        <button
                          ...
                          aria-label={isExpanded ? l10n("local.collapse_sub_tasks_b533f9e8") : l10n("local.expand_sub_tasks_45dcdcbb")}
                          onClick={(event) => {
