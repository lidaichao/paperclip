...
export function workModeMetaList(): WorkModeMeta[] {
  return [
    {
      value: "standard",
      label: l10n("local.auto_mode_9ba1e1b6"),
      icon: Hammer,
      tone: "neutral",
    ...
    {
      value: "planning",
      label: l10n("local.plan_mode_3ca7d842"),
      icon: ClipboardList,
      tone: "planning",
    ...
    {
      value: "ask",
      label: l10n("local.ask_mode_ae649982"),
...
export function titleForPendingWorkMode(mode: IssueWorkMode): string {
  if (mode === "ask") {
    return l10n("local.ask_mode_for_this_submission_click_to_change_d618c6f6");
  }
  if (mode === "planning") {
    return l10n("local.plan_mode_is_on_for_this_submission_click_to_b139911c");
  }
  return l10n("local.auto_mode_for_this_submission_click_to_change_53dcfdaf");
}
